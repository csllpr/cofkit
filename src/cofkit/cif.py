...
class CIFWriter:
    ...
    def write_candidate(
        ...
        result = self.export_candidate(candidate, monomer_specs, data_name=data_name, cofid=cofid)
        out_path = Path(path)
...
def candidate_to_cif(
    ...
    return CIFWriter().export_candidate(candidate, monomer_specs, data_name=data_name, cofid=cofid).text
...
def write_candidate_cif(
    ...
    return CIFWriter().write_candidate(path, candidate, monomer_specs, data_name=data_name, cofid=cofid)
