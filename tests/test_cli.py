...
class CliTests(unittest.TestCase):
    ...
    def test_single_pair_cli_writes_cif(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(summary["first"]["geometry"]["embedding_method"], "etkdg-v3")
            self.assertFalse(summary["first"]["geometry"]["fallback"])
            self.assertEqual(summary["second"]["geometry"]["embedding_method"], "etkdg-v3")
