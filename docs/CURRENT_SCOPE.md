...
- automatic arbitrary-SMILES guest parameterization, GCMC guest-coordinate reinjection into LAMMPS, and full dynamic-GCMC-style MD/MC cycling with synchronized gRASPA/LAMMPS guest force fields beyond the current framework-snapshot `hybrid-mdmc` exchange mode
